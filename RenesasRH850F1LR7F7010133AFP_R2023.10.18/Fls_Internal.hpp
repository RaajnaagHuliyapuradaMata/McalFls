...
#define FLS_INTERNAL_AR_RELEASE_REVISION_VERSION FLS_AR_RELEASE_REVISION_VERSION
...
extern FUNC(void, FLS_PRIVATE_CODE) Fls_DF_write_memory_u32(
   uint32 address,
   uint32 value);
extern FUNC(uint16, FLS_PRIVATE_CODE)Fls_DF_read_memory_u16(uint32 address);
extern FUNC(void, FLS_PRIVATE_CODE) Fls_DF_write_memory_u16(
   uint32 address,
   uint16 value);
extern FUNC(uint8, FLS_PRIVATE_CODE)Fls_DF_read_memory_u08(uint32 address);
extern FUNC(void, FLS_PRIVATE_CODE) Fls_DF_write_memory_u08(
   uint32 address,
   uint8 value);
#endif
...
extern FUNC(uint8,  FLS_PRIVATE_CODE) Fls_CF_read_memory_u08  (const uint32 address);
extern FUNC(uint32, FLS_PRIVATE_CODE) Fls_CF_read_memory_u32  (const uint32 address);
extern FUNC(void,   FLS_PRIVATE_CODE) Fls_CF_write_memory_u08 (const uint32 address, const uint8 value);
#endif
